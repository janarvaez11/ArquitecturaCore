...
public class SeguroServicio {
    ...
    public SeguroServicio(SeguroRepositorio repositorio) {
    ...
    public void update(Seguro Seguro) {
        try{
            ...
            if (seguroOpcional.isPresent()) {
                ...
                throw new SeguroNoEncontradoExcepcion("Seguro", "Error al actualizar el Seguro. No se encontró la Seguro con ID: " + Seguro.getId());
            }
        } catch (Exception rte) {
            throw new ActualizarEntidadExcepcion("Seguro", "Error al actualizar la Seguro. Texto del error: "+rte.getMessage());
        }
    }
    ...
    public void delete(Integer id) {
        try {
            ...
            if (seguroOpcional.isPresent()) {
                ...
                throw new SeguroNoEncontradoExcepcion("Seguro", "Error al eliminar la Seguro. No se encontró el Seguro con ID: " + id);
            }
        } catch (Exception rte) {
            throw new EliminarEntidadExcepcion("Seguro", "Error al eliminar el Seguro. Texto del error: "+rte.getMessage());
        }
    }
